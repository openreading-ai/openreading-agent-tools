...
The small-plugin packager downloads a complete pinned runtime at first use.
Its explicit verified extension input may include the reviewed optional server implementation from another development branch.
Packaging does not merge that source, publish assets, install clients, or establish native acceptance.
