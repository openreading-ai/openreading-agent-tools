...
ProductSpec revision 2 targets a Docling bundle. Its isolated developer feasibility harness, corpus/retrieval gate, and unscored token-probe driver are implemented.
