...
ProductSpec revision 9 targets Claude Desktop and a conditional, named local ChatGPT mode through the same Docling runtime.
...
The reviewed candidate has import, search, read and optional local selection; planned core MCP operations are not already implemented.
