...
The historical marketplace installs a PyMuPDF worker and shared evidence retrieval skill.
No current Claude Code server-client package is assembled. The matrix records that cell as blocked.
